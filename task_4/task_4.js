const startSelect = document.querySelector('.select_button'); //кнопка выбора
const resultNode = document.querySelector('.result_value'); // поле вывода результата
